                ...
                echo "<tr>";
                  ...
                  echo "<td>";
                    echo "<div class='btn-group' role='group' aria-label='...'>";
                      echo "<a href='".base_url()."Admin/EditDoctor/".$doctor['user_id']."' role='button' class='btn btn-default btn-sm'>Edit</a>";
                      echo "<a href='".base_url()."Admin/DeactivateDoctor/".$doctor['user_id']."' role='button' class='btn btn-default btn-sm'>Deactivate</a>";
                    echo "</div>";
                  echo "</td>";
                echo "</tr>";
              }
