        ...
        <div class="col-sm-3">
            <section class="panel">
              ...
              <table class="table">
                  ...
                  <tr>
                    <td colspan="2" align="center"><h5><a href="<?=base_url()?>Admin/NurseList" role="button" class="btn btn-info">SHOW ACTIVE NURSE</a></h5></td>
                  </tr>
              </table>
            </section>
        </div>
                      ...
                      echo "<tr>";
                        ...
                        echo "<td>";
                          echo "<div class='btn-group' role='group' aria-label='...'>";
                            echo "<a href='".base_url()."Admin/ActivateNurse/".$nurse  ['user_id']."' role='button' class='btn btn-default btn-sm'>Activate</a>";
                          echo "</div>";
                        echo "</td>";
                      echo "</tr>";
                    }
