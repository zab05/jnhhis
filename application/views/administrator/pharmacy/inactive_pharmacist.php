        ...
        <section class="panel">
            <header style="font-weight:300" class="panel-heading">
             ...
             <span class="tools pull-right">
				<a data-original-title="Show Inactive Pharmacist"
				   data-placement="top" 
				   data-toggle="tooltip"
				class="tooltips" href="<?=base_url()?>Admin/PharmacistList" role="button" ><i style="color:black" class="fa fa-eye"></i></a>
             </span>
            </header>
			...
			<center>
			<a href="<?=base_url()?>Admin/AddPharmacist" role="button" class="btn btn-sm btn-round btn-success"><i class="fa fa-plus-circle"></i> Add Radiologist</a>
			</center>
			</div>
			</div>
        </section>
                ...
                echo "<tr>";
                  ...
                  echo "<td>";
                    echo "<div class='btn-group' role='group' aria-label='...'>";
                      echo "<a href='".base_url()."Admin/ActivatePharmacist/".$pharmacist['user_id']."' role='button' class='btn btn-success btn-sm'>Activate</a>";
                    echo "</div>";
                  echo "</td>";
                echo "</tr>";
              }
