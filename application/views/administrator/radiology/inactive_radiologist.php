      ...
      <div class="col-sm-3">
          <section class="panel">
              ...
              <table class="table">
                  ...
                  <tr>
                    <td colspan="2" align="center"><h5><a href="<?=base_url()?>Admin/RadiologistList" role="button" class="btn btn-info">SHOW ACTIVE RADIOLOGIST</a></h5></td>
                  </tr>
              </table>
          </section>
      </div>
      <div class="col-sm-9">
        <section class="panel">
          <header class="panel-heading">
              <center><h4>INACTIVE RADIOLOGIST LIST<h4></center>
          </header>
                ...
                echo "<tr>";
                  ...
                  echo "<td>";
                    echo "<div class='btn-group' role='group' aria-label='...'>";
                      echo "<a href='".base_url()."Admin/ActivateRadiologist/".$radiologist['user_id']."' role='button' class='btn btn-default btn-sm'>Activate</a>";
                    echo "</div>";
                  echo "</td>";
                echo "</tr>";
              }
