...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_admission_discharge
AFTER UPDATE ON admission_schedule 
FOR EACH ROW

BEGIN
	insert ignore into discharge_schedule(patient_id)
...
-- Dump completed on 2016-06-27 21:18:39
