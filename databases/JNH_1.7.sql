...
INSERT INTO `admission_schedule` VALUES (2,'PTNT-0001',3,'2016-06-29 11:18:57',NULL),(3,'PTNT-0002',3,'2016-06-29 11:19:30',NULL);
...
BEGIN
	...
	insert into discharge_schedule(patient_id)
    select patient_id from admission_schedule
    where status = 2;
...
INSERT INTO `discharge_schedule` VALUES (1,'PTNT-0002','2016-06-29 11:14:54',NULL),(2,'PTNT-0001','2016-06-29 11:18:56',NULL),(3,'PTNT-0002','2016-06-29 11:19:30',NULL);
...
--
-- Dumping events for database 'jnh_schema'
--
/*!50106 SET @save_time_zone= @@TIME_ZONE */ ;
/*!50106 DROP EVENT IF EXISTS `evnt_admit_dis` */;
DELIMITER ;;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `evnt_admit_dis` ON SCHEDULE EVERY 1 SECOND STARTS '2016-06-29 19:14:04' ON COMPLETION NOT PRESERVE ENABLE DO update admission_schedule
set status = 3
where status = 2 */ ;;
...
-- Dump completed on 2016-06-29 19:41:47
