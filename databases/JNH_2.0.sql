...
CREATE TABLE `laboratory_request` (
  ...
  CONSTRAINT `fk_fast_id2` FOREIGN KEY (`fasting_cat_fk`) REFERENCES `laboratory_request` (`lab_id`),
  CONSTRAINT `fk_lab_patient_2` FOREIGN KEY (`lab_patient`) REFERENCES `patient` (`patient_id`),
  CONSTRAINT `fk_urg_id2` FOREIGN KEY (`urgency_cat_fk`) REFERENCES `laboratory_request` (`lab_id`),
...
CREATE TABLE `laboratory_specimens` (
  ...
  KEY `fk_lab_spec` (`lab_spec_fk`),
  CONSTRAINT `fk_lab_spec` FOREIGN KEY (`lab_spec_fk`) REFERENCES `laboratory_request` (`lab_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-07-01 22:41:20
